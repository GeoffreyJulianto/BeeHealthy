...
void main() {
  runApp(MaterialApp(
    ...
    home: ProductivityProfile1(),
  ));
}

class ProductivityProfile1 extends StatelessWidget {
  @override
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    Color(0xFF8ECBC0), // Light blue (top)
                    Color(0xFF8ECBC0), // Still light blue
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '"Clueless Rookie" represents a perspective on productivity, where you embark on a journey of growth and development. With the mindset of a "Clueless Rookie," you embrace a humble and open-minded approach, acknowledging that you have much to learn and improve upon.',
...
class PieChartPainter extends CustomPainter {
  final List<_PieSegment> segments = [
    _PieSegment(color: Color(0xFF9EFFA2), percentage: 0.65, label: '65% (15.6h)\nLeisure'),
    _PieSegment(color: Color(0xFF647BF6), percentage: 0.25, label: '25% (6h)\nSleep'),
    _PieSegment(color: Color(0xFFFFC78B), percentage: 0.1, label: '10% (2.4h)\nProductive'),
  ];
