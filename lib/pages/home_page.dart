...
import 'package:beehealthy/pages/schedule_page.dart';
// import 'package:beehealthy/pages/results_page.dart';
// import 'package:beehealthy/pages/profile_page.dart';
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Text("Gervasius Russell", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            Container(
            ...
            const Text("RUSSELL’S ACTIVITY", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
            const SizedBox(height: 20),
            buildTimeline([
