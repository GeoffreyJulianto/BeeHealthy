...
void main() {
  runApp(MaterialApp(
    ...
    home: ProductivityProfile4(),
  ));
}

class ProductivityProfile4 extends StatelessWidget {
  @override
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    Color(0xFFC0D6DF), // Light blue (top)
                    Color(0xFFC0D6DF), // Still light blue
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Being an "Elite Conqueror" goes beyond simply getting things done. It\'s about conquering your personal and professional goals with mastery and finesse. You\'ll leverage cutting-edge tools, innovative techniques, and time-tested strategies to optimize your productivity and maximize your impact.',
...
class PieChartPainter extends CustomPainter {
  final List<_PieSegment> segments = [
    _PieSegment(color: Color(0xFF9EFFA2), percentage: 0.35, label: '35% (8.4h)\nLeisure'),
    _PieSegment(color: Color(0xFF647BF6), percentage: 0.25, label: '25% (6h)\nSleep'),
    _PieSegment(color: Color(0xFFFFC78B), percentage: 0.4, label: '40% (9.6h)\nProductive'),
  ];
